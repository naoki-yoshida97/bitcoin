...
private:
    ...
    {
        BitcoinProfiler* lockProfiler = BitcoinProfiler::ShouldProfileLock() && BitcoinProfiler::IsLoaded() ? new BitcoinProfiler(std::string("LOCK(") + pszName + "L" + std::to_string(nLine) + ")", true, true) : nullptr;
