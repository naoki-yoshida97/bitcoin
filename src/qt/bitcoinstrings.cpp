...
QT_TRANSLATE_NOOP("bitcoin-core", "Specify additional configuration file(s), relative to the -datadir path (or the path of the file in which the statement occurs, if read from a file)"),
