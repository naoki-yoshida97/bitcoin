...
UniValue importprivkey(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            request.check(RPCHelpMan{"importprivkey",
...
UniValue abortrescan(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            request.check(RPCHelpMan{"abortrescan",
...
UniValue importaddress(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            request.check(RPCHelpMan{"importaddress",
...
UniValue importprunedfunds(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            request.check(RPCHelpMan{"importprunedfunds",
...
UniValue removeprunedfunds(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            request.check(RPCHelpMan{"removeprunedfunds",
...
UniValue importpubkey(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            request.check(RPCHelpMan{"importpubkey",
...
UniValue importwallet(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            request.check(RPCHelpMan{"importwallet",
...
UniValue dumpprivkey(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            request.check(RPCHelpMan{"dumpprivkey",
...
UniValue dumpwallet(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            request.check(RPCHelpMan{"dumpwallet",
...
UniValue importmulti(const JSONRPCRequest& mainRequest)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, mainRequest.fHelp)) {
        return NullUniValue;
            ...
            mainRequest.check(RPCHelpMan{"importmulti",
