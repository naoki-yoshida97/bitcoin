...
{
            request.check(RPCHelpMan{"getblockcount",
...
{
            request.check(RPCHelpMan{"getbestblockhash",
...
{
            request.check(RPCHelpMan{"waitfornewblock",
...
{
            request.check(RPCHelpMan{"waitforblock",
                "\nWaits for a specific new block and returns useful info about it.\n"
                "\nReturns the current block on timeout or exit.\n",
                {
...
{
            request.check(RPCHelpMan{"waitforblockheight",
...
{
            request.check(RPCHelpMan{"syncwithvalidationinterfacequeue",
...
{
            request.check(RPCHelpMan{"getdifficulty",
...
{
            request.check(RPCHelpMan{"getrawmempool",
...
{
            request.check(RPCHelpMan{"getmempoolancestors",
...
{
            request.check(RPCHelpMan{"getmempooldescendants",
...
{
            request.check(RPCHelpMan{"getmempoolentry",
...
{
            request.check(RPCHelpMan{"getblockhash",
...
{
            request.check(RPCHelpMan{"getblockheader",
...
{
    request.check(RPCHelpMan{"getblock",
...
{
            request.check(RPCHelpMan{"pruneblockchain", "",
                {
...
{
            request.check(RPCHelpMan{"gettxoutsetinfo",
...
{
            request.check(RPCHelpMan{"gettxout",
...
static UniValue verifychain(const JSONRPCRequest& request)
{
    ...
    int nCheckDepth = gArgs.GetArg("-checkblocks", DEFAULT_CHECKBLOCKS);
            request.check(RPCHelpMan{"verifychain",
...
{
            request.check(RPCHelpMan{"getblockchaininfo",
...
{
            request.check(RPCHelpMan{"getchaintips",
...
{
            request.check(RPCHelpMan{"getmempoolinfo",
...
{
            request.check(RPCHelpMan{"preciousblock",
...
{
            request.check(RPCHelpMan{"invalidateblock",
...
{
            request.check(RPCHelpMan{"reconsiderblock",
...
{
            request.check(RPCHelpMan{"getchaintxstats",
...
{
    request.check(RPCHelpMan{"getblockstats",
...
{
            request.check(RPCHelpMan{"savemempool",
...
{
            request.check(RPCHelpMan{"scantxoutset",
...
{
            request.check(RPCHelpMan{"getblockfilter",
