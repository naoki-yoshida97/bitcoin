...
{
            request.check(RPCHelpMan{"getnetworkhashps",
...
{
            request.check(RPCHelpMan{"generatetoaddress",
...
{
            request.check(RPCHelpMan{"getmininginfo",
...
{
            request.check(RPCHelpMan{"prioritisetransaction",
...
{
            request.check(RPCHelpMan{"getblocktemplate",
...
static UniValue submitblock(const JSONRPCRequest& request)
{
    // We allow 2 arguments for compliance with BIP22. Argument 2 is ignored.
            request.check(RPCHelpMan{"submitblock",
...
{
            request.check(RPCHelpMan{"submitheader",
...
{
            request.check(RPCHelpMan{"estimatesmartfee",
...
{
            request.check(RPCHelpMan{"estimaterawfee",
